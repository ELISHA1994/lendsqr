# Lendsqr Nest CQRS Bank Rest api
...
- Showing how you can implement CQRS pattern
- Showing how you can implement Event Sourcing pattern
...
```bash
  git clone https://github.com/ELISHA1994/lendsqr.git
```
...
```bash
  docker run -d -p 5000:5000 lendsqr
...
## Configuration
All configuration is in [src/app.config.ts](https://github.com/ELISHA1994/nestJS-sample/blob/master/src/app.config.ts)
...
## Scripts
```bash
  git clone https://github.com/ELISHA1994/lendsqr.git # clone this project

  # run mysql database container
  docker run --name nest -d -p 3306:3306 -e MYSQL_DATABASE=nest -e MYSQL_ROOT_PASSWORD=test -v ~/database/nest:/var/lib/mysql mysql:5.7

  docker build -t lendsqr # build docker image named lendsqr

  docker images # list up docker images

  docker run -d -p 5000:5000 lendsqr # run docker container using image named lendsqr (host port 5000 is mapped container port 5000 and container run background process)
...
## Links
Github: [https://github.com/ELISHA1994/lendsqr.git](https://github.com/ELISHA1994/lendsqr.git)

Dockerhub: [https://cloud.docker.com/repository/docker/elisha1994/lendsqr/](https://cloud.docker.com/repository/docker/elisha1994/lendsqr/)
